"""
Unified YOLOv8 Testing Script
Combines video processing and metrics generation
Usage: python yolov8.py --video <path> [--model <path>] [--conf <0.5>] [--data <path>]
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description='YOLOv8 Testing and Evaluation')
...
def main():
    ...
    print("=" * 60)
    print("YOLOv8 Testing and Evaluation")
    print("=" * 60)
    ...
    if not validation_data:
        ...
        script_dir = Path(__file__).parent
        possible_data_paths = [
            script_dir.parent.parent / 'drive-download-20251215T134537Z-3-001' / 'YOLOv8m' / 'data' / 'data.yaml',
            script_dir / 'data' / 'data.yaml',
            script_dir.parent.parent / 'YOLOv8m' / 'data' / 'data.yaml'
        ]
